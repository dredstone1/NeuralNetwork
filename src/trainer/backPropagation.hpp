...
class BackPropagation {
  private:
	...
	void calculate_gradient(const model::ILayer &layer, const global::ParamMetrix &deltas, const global::ParamMetrix &prevLayer, model::LayerParameters &gradients);
	void calculateGradientForWeights(const model::ILayer &layer, const global::ParamMetrix &prevLayer, const global::ParamMetrix &deltas, model::LayerParameters &gradients);
	void calculateGradientForBiases(const model::ILayer &layer, const global::ParamMetrix &deltas, model::LayerParameters &gradients);

	global::ValueType run_back_propagation(const TrainSample &sample);
	global::ParamMetrix calculateDeltaHidden(const model::Hidden_Layer &current_layer, const model::ILayer &next_layer, const global::ParamMetrix &next_deltas);
